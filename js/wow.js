...
(function() {
    ...
    a = function() {
        ...
        for (e = arguments[0], c = 2 <= arguments.length ? b.call(arguments, 1) 
            : [], g = e || {}, i = 0, j = c.length;
        j > i;
        i++) {
            f = c[i], k = f || {};
        ...
        return b.prototype.defaults = {
            ...
            var a, b, c, d;
            if (this.element = window.document.documentElement, this.boxes = this.element.getElementsByClassName(this.config.boxClass)
                , this.boxes.length) {
